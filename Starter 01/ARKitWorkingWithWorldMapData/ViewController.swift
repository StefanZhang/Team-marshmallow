...
class ViewController: UIViewController, ARSessionDelegate {
    ...
    @objc func didReceiveTapGesture(_ sender: UITapGestureRecognizer) {
        ...
        //changed
        // when tap on screen, show the hight of camera compared to surface, and coordinate of the ball
    ...
    // changed
//    func generateSphereNode() -> SCNNode {
//        let cubic = SCNBox(width: 0.05,height: 0.05,length:0.05, chamferRadius: 0.0)
//        let cubicNode = SCNNode()
//        cubicNode.position.y += Float(cubic.height)
//        print(cubicNode.position.y)
//        cubicNode.geometry = cubic
//        return cubicNode
//    }
